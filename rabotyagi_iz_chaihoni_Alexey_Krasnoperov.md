...
сообщество - https://vk.com/anekdotikategoriib, название - Реклама паблика с анекдотами), рекламная кампания отображается в списке кампаний.
- Кампании. Создание. Одноклассники. После создания рекламной кампании сообщества ОК (например:
сообщество - https://ok.ru/group/70000006161887/hobby, название - Реклама сообщества про соленые огурцы), рекламная кампания отображается в списке кампаний.
...
- Кампании. Создание. Настройка кампании. Сайт. Ошибка при не введённой ссылки на сайт
...
- Кампании. Создание. Настройка кампании. VK Mini Apps и игры. При вводе в поле "Мини-приложение" появляется список соответствующих приложений
- Кампании. Создание. Настройка кампании. Аудиозаписи. При вводе в поле "Аудиозаписи" появляется список соответствующих аудиозаписей
- Кампании. Создание. Настройка кампании. Видеозаписи. При вводе в поле "Видеозаписи" появляется список соответствующих видеозаписей
...
- Кампании. Создание. Группы. Интересы и поведение. При вводе в поле для ввода названия сообществ появляется список соответствующих сообществ
...
- Кампании. Создание. Группы. Интересы и поведение. При вводе в поле в блоке "Музыканты" появляется список соответствующих музыкантов
...
- Кампании. Создание. Группы. Параметры URL. Ошибка при вводе UTM-метки, несоответствующей [требованиям](https://ads.vk.com/help/articles/utm), в пункте "Добавлять UTM-метки вручную"
- Кампании. Создание. Группы. Места размещения. При изменении блока меняется блок целевой аудитории и прогноза
- Кампании. Создание. Группы. Места размещения. При отключении "Автоматического выбора мест размещения" появляется список мест размещений
- Кампании. Создание. Группы. При нажатии на кнопку "Добавить еще группу" появляется новая группа в дереве кампании
...
- Кампании. Создание. Объявления. В форме генерации текста при вводе в поле "Текст для генерации вариантов" не менее
4 слов и нажатии на кнопку "Сгенерировать" появляется список сгенерированных текстов
...
- Кампании. Создание. При переходе на "Группы объявлений" в дереве кампании появляется новая группа
